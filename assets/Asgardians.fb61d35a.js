import { _ as _export_sfc, u as useI18n, m as mapState, q as mapMutations, l as mapActions, c as computed, r as reactive, w as watch, C as onMounted, a as resolveComponent, o as openBlock, g as createBlock, s as unref, b as createElementBlock, d as createBaseVNode, t as toDisplayString, e as createVNode, E as _sfc_main$1, x as normalizeClass, B as Button, v as createTextVNode, F as Fragment, f as renderList, h as createCommentVNode, j as delay, z as message, n as numberWithSpaces, L as Loader } from './index.bc61808c.js';
import { A as Avatar } from './Avatar.f9f68fe1.js';
import { E as EmptyLabel } from './EmptyLabel.f0073232.js';

const Asgardians_vue_vue_type_style_index_0_scoped_68bc0204_lang = '';
...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    const canInvite = computed(() => {
        return data.total < (user.value.max_invites_count || settings.MAX_INVITES_COUNT)
    });
...
const Asgardians = /*#__PURE__*/_export_sfc(_sfc_main, [['__scopeId',"data-v-68bc0204"]]);
