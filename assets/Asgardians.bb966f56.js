import { _ as _export_sfc, u as useI18n, m as mapState, q as mapMutations, l as mapActions, c as computed, r as reactive, w as watch, C as onMounted, a as resolveComponent, o as openBlock, g as createBlock, s as unref, b as createElementBlock, d as createBaseVNode, t as toDisplayString, e as createVNode, E as _sfc_main$1, x as normalizeClass, B as Button, v as createTextVNode, F as Fragment, f as renderList, h as createCommentVNode, j as delay, z as message, n as numberWithSpaces, L as Loader } from './index.601fe2ff.js';
import { A as Avatar } from './Avatar.58231854.js';
import { E as EmptyLabel } from './EmptyLabel.035cac11.js';

const Asgardians_vue_vue_type_style_index_0_scoped_6bb205b8_lang = '';
      ...
      ? (openBlock(), createElementBlock("div", _hoisted_1, [
          ...
          (!data.asgrs.length)
            ...
            : (openBlock(), createElementBlock("div", _hoisted_5, [
                createBaseVNode("span", null, toDisplayString(data.total) + " / " + toDisplayString(unref(user).profile.max_invites_count || unref(settings).MAX_INVITES_COUNT) + " " + toDisplayString(unref(t)('common.asgrs')), 1),
...
const Asgardians = /*#__PURE__*/_export_sfc(_sfc_main, [['__scopeId',"data-v-6bb205b8"]]);
