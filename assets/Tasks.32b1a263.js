import { _ as _export_sfc, u as useI18n, m as mapState, q as mapMutations, l as mapActions, C as getCurrentInstance, r as reactive, w as watch, D as onMounted, a as resolveComponent, o as openBlock, g as createBlock, b as createElementBlock, e as createVNode, d as createBaseVNode, t as toDisplayString, s as unref, v as createTextVNode, F as Fragment, f as renderList, B as Button, h as createCommentVNode, j as delay, n as numberWithSpaces, E as withModifiers, L as Loader, z as message } from './index.6a688994.js';
import { E as EmptyLabel } from './EmptyLabel.f4c8d672.js';

const Tasks_vue_vue_type_style_index_0_scoped_dd208009_lang = '';
...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    const WebApp = app.appContext.config.globalProperties.$webapp;
...
return (_ctx, _cache) => {
  ...
  return (data.loading && !data.tasks.length)
    ...
    : (openBlock(), createElementBlock("div", _hoisted_1, [
        ...
        createTextVNode(" //" + toDisplayString(unref(WebApp).initData) + "// ", 1),
...
const Tasks = /*#__PURE__*/_export_sfc(_sfc_main, [['__scopeId',"data-v-dd208009"]]);
